...
exports.addsaleproduct = function(req, res) {
  console.log(req.body);
  var createObj = {
    product_id: req.body.ProductId || "",
    product_qty: req.body.qty || "",
    product_price: req.body.price || "",
    supplier_id: req.body.UserId || "",
    Currency: req.body.currency,
    Date: req.body.date,
    supplier_email: req.body.SupEmail,
    supplier_name: req.body.SupName
  };

  sellerCRUD.create(createObj, function(err, data) {
    if (!err) {
      //       var subject = "Tradeexchange.co - New Product";

      //       var to =
      //           req.body.supplier_email +
      //         ",amit.k@fountaintechies.com,ceo@80startups.com,shital.talole@fountaintechies.com,office@80startups.com";
      //       var mailbody =
      ...
      // <td style="text-align: center; padding: 8px 10px;">\
      // <div>\
      // <img style="width: 60px; height: auto; margin: 0 auto; display: block; padding: 8px 10px;" src="https://www.tradeexchange.co/uploads/' +
      //         fileName +
      ...
      // <div><a href="https://www.tradeexchange.co/product_detail.html?id=' +
      //         data.insertId +
      //         '" target="_blank" style="display: inline-block;padding: 9px 12px; background-color: #52bbd5;margin-top: 45px;color: #ffffff; text-decoration: none;">View Product</a></div></div>\
      // </div>\
      // </div>\
      // </div>\
      // </div>\
...
exports.addbuyproduct = function(req, res) {
  console.log(req.body);
  var createObj = {
    product_id: req.body.ProductId || "",
    product_qty: req.body.qty || "",
  ...
  buyerCRUD.create(createObj, function(err, data) {
    if (!err) {
      //       var subject = "Tradeexchange.co - New Product";
...
exports.addproduct = function(req, res) {
  ...
  productCRUD.create(createObj, function(err, data) {
    if (!err) {
      ...
      var to =
        req.body.SupEmail +
        ",komal.gaikwad@fountaintechies.com,ceo@80startups.com,shital.talole@fountaintechies.com,office@80startups.com,magnusideas5@gmail.com";
      var mailbody =
        '<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>\
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">\
<meta name="viewport" content="width=device-width">\
...
exports.updateproduct = function(req, res) {
  ...
  // console.log("after", createObj);
  productCRUD.update({ ProductId: req.body.ProductId }, updateObj, function(
    err,
    val
  ) {
    if (!err) {
...
exports.showSpecification = function(req, res) {
  ...
  var sql =
    "SELECT * FROM `tbl_ProductSpecification` WHERE SpecificationId = " +
    SpecificationId;
  console.log(sql);
...
exports.deleteSpecification = function(req, res) {
  var SpecificationId = req.params.id;
  var sql =
    "DELETE FROM `tbl_ProductSpecification` WHERE SpecificationId = " +
    SpecificationId;
  console.log(sql);
  db.query(sql, function(err, data) {
    res.json(data);
...
exports.disableProduct = function(req, res) {
  ...
  var sql =
    "UPDATE `tbl_Products` SET IsDisabled = '1' WHERE ProductId = " + ProductId;
  console.log(sql);
  db.query(sql, function(err, data) {
    res.json(data);
  });
...
exports.enableProduct = function(req, res) {
  var ProductId = req.params.id;
  var sql =
    "UPDATE `tbl_Products` SET IsDisabled = '0' WHERE ProductId = " + ProductId;
  console.log(sql);
  db.query(sql, function(err, data) {
    res.json(data);
  });
...
exports.userproducts = function(req, res) {
  ...
  var sql =
    "SELECT p.`ProductId`,p.`ProductName`,p.`Currency`,p.`Description`,p.`Price`,p.`Image1`,p.`IsDisabled`,ct.`CategoryTitle`,c.`CountryFlag` FROM `tbl_Products` as p LEFT JOIN `tbl_Countries` as c ON c.`CountryId` = p.`CountryId` LEFT JOIN `tbl_Categories` as ct ON ct.`CategoryId` = p.`CategoryId` WHERE p.ProductType='Product' AND p.`SupplierId` = " +
    SupId +
...
exports.sellerorders = function(req, res) {
  ...
  var sql =
    "SELECT `OrderId`,p.`ProductName`,s.`FirstName`,s.`LastName`,o.`TotalAmount`,o.`OrderDate`,o.`PaymentStatus`,o.`OrderStatus` FROM `tbl_Orders` as o LEFT JOIN `tbl_Products` as p ON p.`ProductId` = o.`ProductId` LEFT JOIN `tbl_Suppliers` as s ON o.`BuyerId` = s.`SupId` WHERE o.`SuplierId` = " +
    SellerId +
    " GROUP BY o.`OrderId` ORDER BY o.`OrderId` DESC"; //console.log(sql);
  console.log(sql);
  db.query(sql, function(err, data) {
    res.json(data);
  });
...
exports.getOrderDetails = function(req, res) {
  ...
  var sql =
    "SELECT o.*,p.`ProductName`,p.`Currency`,p.`ProductId`,p.`Image1`,s.`FirstName`,s.`LastName`,s.`Email`,s.`CompanyName`,c.`CountryTitle` FROM `tbl_Orders` as o LEFT JOIN `tbl_Products` as p ON p.`ProductId` = o.`ProductId` LEFT JOIN `tbl_Suppliers` as s ON o.`BuyerId` = s.`SupId` LEFT JOIN `tbl_Countries` as c ON s.`CountryId` = c.`CountryId` WHERE o.`OrderId` = " +
    OrderId;
  console.log(sql);
  db.query(sql, function(err, data) {
    res.json(data[0]);
...
exports.getTerms = function(req, res) {
  var OrderId = req.params.id;
  var sql =
    "SELECT * FROM `tbl_Terms` WHERE OrderId = " +
    OrderId +
    " AND IsEdited = '0' ORDER BY TermId ASC";
  console.log(sql);
  db.query(sql, function(err, data) {
    res.json(data);
  });
...
exports.sellerTerms = function(req, res) {
  ...
  orderCRUD.update({ OrderId: req.body.OrderId }, updateObj, function(
    err,
    val
  ) {
    if (!err) {
      ...
      termsCRUD.update({ OrderId: req.body.OrderId }, updateObj, function(
        err1,
        val1
      ) {
        var table = "";
...
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">' +
            req.body.terms[i].Terms +
            '</p>\
</td>\
<td style="text-align: center; padding: 8px 10px;">\
<div>\
<p style="margin: 0px; font-size: 14px;">' +
            req.body.terms[i].Type +
            '</p>\
</div>\
</td>\
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">' +
            req.body.terms[i].Percentage +
            ' %</p>\
</td>\
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">' +
        ...
        var subject =
          "Tradeexchange Updated Proposal- " + req.body.order.OrderId;
...
<div style="font-size:12px;line-height:14px;color:#000000;font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 18px; line-height: 21px;"><strong>Shipping Address</strong></span></p><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 14px; line-height: 16px;"><b>Name : </b>' +
          req.body.order.FirstName +
          " " +
          req.body.order.LastName +
          '</span></p><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 14px; line-height: 16px;"><b>Address Line 1 : </b>' +
          req.body.order.Address1 +
          " <br><b>Address Line 2 :</b> " +
          req.body.order.Address2 +
          " <br><b>Postal Code :</b> " +
          req.body.order.PostalCode +
          "<br><b>Country : </b>" +
          req.body.order.Country +
          '<br></span></p></div>\
</div>\
</div>\
</div>\
...
<div style="font-size:12px;line-height:14px;color:#000000;font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: right"><strong><span style="font-size: 18px; line-height: 21px;">Seller Details</span></strong><br></p><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: right"><span style="font-size: 14px; line-height: 16px;"><b>Name :</b> ' +
          sellername +
          '</span></p><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: right"><span style="font-size: 14px; line-height: 16px;"> <b>Country :</b> ' +
          sellercountry +
          '<br><br></span></p></div>\
</div>\
</div>\
...
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">' +
          req.body.order.ProductId +
          '</p>\
</td>\
<td style="text-align: center; padding: 8px 10px;">\
<div>\
<img style="width: 60px; height: auto; margin: 0 auto; display: block; padding: 8px 10px;" src="https://www.tradeexchange.co/uploads/' +
          req.body.order.Image1 +
          '" class="img-responsive"></div>\
</td>\
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">' +
          req.body.order.ProductName +
          '</p>\
</td>\
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">' +
...
<div><a href="https://www.tradeexchange.co/buyer-order-details.html?id=' +
          req.body.order.OrderId +
          '" target="_blank" style="display: inline-block;padding: 9px 12px; background-color: #52bbd5;margin-top: 45px;color: #ffffff; text-decoration: none;">View Orders</a></div></div>\
</div>\
</div>\
</div>\
</div>\
...
<div><a href="https://www.tradeexchange.co/seller-order-details.html?id=' +
          req.body.order.OrderId +
          '" target="_blank" style="display: inline-block;padding: 9px 12px; background-color: #52bbd5;margin-top: 45px;color: #ffffff; text-decoration: none;">View Orders</a></div></div>\
</div>\
</div>\
...
exports.sellerapprove = function(req, res) {
  ...
  orderCRUD.update({ OrderId: req.body.order.OrderId }, updateObj, function(
    err,
    val
  ) {
    if (!err) {
      ...
      termsCRUD.update({ OrderId: req.body.order.OrderId }, updateObj, function(
        err1,
        val1
      ) {
        var table = "";
...
<p style="margin: 0px; font-size: 14px;">' +
        ...
        // var seller = 'komal.gaikwad@fountaintechies.com';
        var subject =
          "Tradeexchange Order Confirmation- " + req.body.order.OrderId;
...
exports.getHistory = function(req, res) {
  var OrderId = req.params.id;
  var sql =
    "SELECT  `SellerMessage`,`BuyerMesssage`,`TermDate` FROM `tbl_Terms` WHERE OrderId = " +
    OrderId +
    " GROUP BY TermDateTime ORDER BY TermId DESC";
  console.log(sql);
  db.query(sql, function(err, data) {
    res.json(data);
  });
