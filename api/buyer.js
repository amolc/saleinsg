...
<p style="margin: 0px; font-size: 14px;">'+req.body.order.Currency+' '+req.body.terms[i].Amount+'</p>\
     ...
     var buyer = req.body.order.buyeremail+',ceo@80startups.com,shital.talole@fountaintechies.com,office@80startups.com,magnusideas5@gmail.com';
     var seller = req.body.order.Email+',ceo@80startups.com,shital.talole@fountaintechies.com,office@80startups.com,magnusideas5@gmail.com';
   // console.log(buyer);
   // console.log(seller);                            
...
<div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 5px; padding-left: 5px;">\
<div style="font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#52BAD5; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;">\
<div style="font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#52BAD5;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="font-size: 20px; line-height: 24px;"><strong><span style="line-height: 24px; font-size: 20px;">Withdraw Request!</span></strong></span></p><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"></p></div>\
</div>\
</div>\
</div>\
</div>\
...
exports.payNow = function (req, res) {
  ...
  random = randomString();
   ...
   var sellercountry = req.body.CountryTitle;
    ...
    if (!err) 
    {
            ...
            var updateObj = {
                   'PaymentStatus' : 'Paid',
                   'PaymentDate' : req.body.datetime,
              };

            termsCRUD.update({TermId: req.body.TermId}, updateObj,function(err1, val1) {
             ...
             count = 0;
              ...
              {    
               ...
               var Percentage = req.body.terms[i].Percentage;
               var Amount = req.body.terms[i].Amount;
               if (req.body.terms[i].TermId == req.body.TermId)
                    payStatus = 'Paid';
               else
                    payStatus = req.body.terms[i].PaymentStatus;
...
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">'+req.body.Currency+' '+req.body.terms[i].Amount+'</p>\
</td>\
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">'+payStatus+'</p>\
</td>\
</tr>';
            ...
            if (count == 0) 
            {
                ...
                orderCRUD.update({OrderId: req.body.OrderId}, updateObj,function(err6, val6) {
                                                    
               });

            }

             var buyer = req.body.buyeremail+',komal.gaikwad@fountaintechies.com,ceo@80startups.com,shital.talole@fountaintechies.com,office@80startups.com,magnusideas5@gmail.com';
             var seller = req.body.Email+',komal.gaikwad@fountaintechies.com,ceo@80startups.com,shital.talole@fountaintechies.com,office@80startups.com,magnusideas5@gmail.com';
   // console.log(buyer);
   // console.log(seller);                            

               //var buyer = 'komal.gaikwad@fountaintechies.com';
               //var seller = 'komal.gaikwad@fountaintechies.com';
               var subject = "Tradeexchange Order Payment - "+req.body.OrderId;
...
<div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 5px; padding-left: 5px;">\
<div style="font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#52BAD5; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;">\
<div style="font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#52BAD5;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="font-size: 20px; line-height: 24px;"><strong><span style="line-height: 24px; font-size: 20px;">Order Payment!</span></strong></span></p><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"></p></div>\
</div>\
</div>\
</div>\
</div>\
...
<td style="text-align: center; padding: 8px 10px;">\
<p style="margin: 0px; font-size: 14px;">'+req.body.Currency+' '+req.body.TotalAmount+'</p>\
</td>\
</tr>\
</tbody>\
</table>\
...
<th style="width:50; padding: 5px 10px; font-size: 14px;">%</th>\
<th style="width:120px; padding: 5px 10px; font-size: 14px;">Amount</th>\
<th style="width:120px; padding: 5px 10px; font-size: 14px;">Payment</th>\
</tr>\
</thead>\
<tbody>'+table+'</tbody>\
</table>\
<div><a href="https://www.tradeexchange.co/buyer-order-details.html?id='+req.body.OrderId+'" target="_blank" style="display: inline-block;padding: 9px 12px; background-color: #52bbd5;margin-top: 45px;color: #ffffff; text-decoration: none;">View Orders</a></div></div>\
</div>\
</div>\
</div>\
</div>\
...
<div style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">\
<div align="center"><div style="border-top: 1px dotted #CCCCCC; width:100%; line-height:1px; height:1px; font-size:1px;">&#160;</div></div>\
<p><strong>Amount Paid : </strong>SGD $'+req.body.Charge+'</p>\
</div>\
</div>\
</div>\
</div>\
...
<div><a href="https://www.tradeexchange.co/seller-order-details.html?id='+req.body.OrderId+'" target="_blank" style="display: inline-block;padding: 9px 12px; background-color: #52bbd5;margin-top: 45px;color: #ffffff; text-decoration: none;">View Orders</a></div></div>\
</div>\
</div>\
</div>\
</div>\
