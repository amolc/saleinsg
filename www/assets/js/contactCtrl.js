...
app.controller("contactcontroller", function(
  ...
  $scope.contactUS3 = function(code, result) {
    ...
    if (
      ...
      if (
        ...
        $http
          .post(baseurl + "contactus", $scope.data)
          .success(function(res) {
            $scope.response = res;
            console.log(res);
            $scope.formhide = true;
            $scope.msg1 = true;
            $scope.message =
              "Thank you for contacting us./nOur Team will contact you real soon.";
            $scope.data = {
              company_name: "",
              email: "",
              phone: ""
  ...
  $scope.register = function(formRegistration) {
    ...
    if (typeof $scope.registration.CountryId === "undefined") {
      ...
      $http
        .post(baseurl + "register", $scope.registration)
  ...
  $scope.verify = function() {
    ...
    if (parts.length > 0) {
      ...
      $http
        .get(baseurl + "verify-account/" + $scope.verificationstring)
        .success(function(res) {
          if (res.status == "false") {
          } else {
  ...
  $scope.login = function(logininfo, formLogin) {
    ...
    $http
      .post(baseurl + "login", $scope.logininfo)
      .success(function(data, status) {
        console.log(data);
  ...
  $scope.getUserInfo = function() {
    $scope.User_Id = window.localStorage.getItem("User_Id");
    $http
      .get(baseurl + "userinfo/" + $scope.User_Id)
      .success(function(res) {
        if (res.status == "false") {
        } else {
          //console.log(res);
  ...
  $scope.updateprofile = function(info, attachment) {
    ...
    $http
      .post(baseurl + "updateprofile", $scope.info)
      .success(function(data, status) {
        console.log("data", data);
  ...
  $scope.updatebankdetails = function(info) {
    ...
    $http
      .post(baseurl + "updatebankdetails", $scope.info)
      .success(function(data, status) {
        //      console.log('data',data)
  ...
  $scope.updatepassword = function(info) {
    ...
    if (info.Password != info.opassword) {
      ...
      $http
        .post(baseurl + "updatepassword", $scope.info)
        .success(function(data, status) {
          //      console.log('data',data)
  ...
  $scope.getSubCat = function() {
    $http
      .get(baseurl + "getsubcategories/" + $scope.product.CategoryId)
      .success(function(res) {
        if (res.status == "false") {
        } else {
          // console.log(res);
  ...
  $scope.getSubCatlist = function(CategoryId) {
    ...
    if (parts.length > 1) {
      ...
      //alert(CategoryId);
      $http
        .get(baseurl + "getsubcategories/" + catId)
        .success(function(res) {
          if (res.status == "false") {
          } else {
            // console.log(res);
  ...
  $scope.requestproduct = function(product) {
    ...
    if (typeof $scope.product.CategoryId === "undefined") {
      ...
      $scope.product.CountryId = parseInt(
        window.localStorage.getItem("User_Location")
      );
      $http
        .get(baseurl + "getcountry/" + $scope.product.CountryId)
        .success(function(data, status) {
          // console.log(data);
          ...
          $http
            .post(baseurl + "requestproduct/", $scope.product)
            .success(function(res) {
              $("#imagepreview")
                .children()
                .remove();
  ...
  $scope.saveproduct = function(product) {
    ...
    if (typeof $scope.product.CategoryId === "undefined") {
      ...
      $http
        .post(baseurl + "addproduct/", $scope.product)
        .success(function(res) {
          $("#imagepreview")
            .children()
            .remove();
  ...
  $scope.saleproduct = function(product) {
    console.log($scope.product);
    console.log("in sale product ");

    $scope.product.CountryId = window.localStorage.getItem("User_Location");
    $scope.product.UserId = window.localStorage.getItem("User_Id");
    $scope.product.SupEmail = window.localStorage.getItem("User_Email");
    $scope.product.SupName = window.localStorage.getItem("User_Name");
    var date = new Date();
    var date1 = date.toLocaleDateString("en-GB", {
      timeZone: "Asia/Singapore"
    });
    ...
    $http
        .post(baseurl + "addsaleproduct/", $scope.product)
        .success(function (res) {
            $scope.alertmessage = "Product Details added sucessfully";
    ...
    $scope.buyproducts = function (product) {
        ...
        $http
            .post(baseurl + "addbuyproduct/", $scope.product)
            .success(function (res) {
                $scope.alertmessage = "Product Details added sucessfully";
    ...
    $scope.getRandomSpan = function () {
        return Math.floor((Math.random() * 8976) + 79);
    }
    $scope.getRandomSpan1 = function () {
        return Math.floor((Math.random() * 7695) + 56);
    }

  $scope.sellerBuyerInfo = function(pId) {
    console.log("in seller buyer info call");
    console.log("Product id is:", pId);
    $http
      .get(baseurl + "sellerInfo/" + pId)
      .success(function(res) {
        $scope.sellerData = res;
        console.log("seller Data for product page is: ", $scope.sellerData);
      })
      .error(function() {
        console.log(
          "error while fetching data for seller info from seller info api call"
        );
      });
  };

  $scope.buyerInfo = function(pId) {
    console.log("buyer info call");
      console.log("Product id is:", pId);
    $http
      .get(baseurl + "buyerInfo/"+pId)
      .success(function(res) {
        $scope.buyerData = res;
        console.log("buyer Data for product Page", $scope.buyerData);
      })
      .error(function() {
        console.log("problem while fetching the info of buyer");
      });
  };
  ...
  $scope.updateproduct = function(product) {
    ...
    $http
      .post(baseurl + "updateproduct/", $scope.product)
      .success(function(res) {
  ...
  $scope.showSpecification = function(index, SpecificationId) {
    ...
    $http
      .get(baseurl + "showSpecification/" + $scope.SpecificationId)
      .success(function(data, status) {
        $scope.spec = data;
      });
  };
  ...
  $scope.deleteSpecification = function(index, SpecificationId) {
    ...
    if (r == true) {
      ...
      $scope.SpecificationId = SpecificationId;
      $http
        .get(baseurl + "deleteSpecification/" + $scope.SpecificationId)
        .success(function(data, status) {
  ...
  $scope.specedit = function(spec, product) {
    ...
    $http
      .post(baseurl + "specedit", $scope.spec)
      .success(function(data, status) {
        if (data.status == true) {
          document.addproduct2.reset();
          if (data.message == "update")
            $scope.specification[$scope.index] = $scope.spec;
          if (data.message == "add") $scope.specification.push($scope.spec);
  ...
  $scope.savespecification = function(spec) {
    $http
      .post(baseurl + "addspecification/", $scope.spec)
      .success(function(res) {
        document.addproduct2.reset();
  ...
  $scope.allproducts = function(req, res) {
    ...
    if (parts.length > 1) {
      ...
      if (urlpart.length == 1) {
        ...
        if (id[0] == "category") {
          $http
            .get(baseurl + "filterbycategory/" + id[1])
            .success(function(data, status) {
          ...
          $http
            .get(baseurl + "filterbycountry/" + id[1])
            .success(function(data, status) {
              $scope.productslist = data;
          ...
          $http
            .get(baseurl + "filterbyseller/" + id[1])
            .success(function(data, status) {
              $scope.productslist = data;
              window.localStorage.setItem("filter_seller", id[1]);
              $scope.SellerId = id[1];
              $http
                .get(baseurl + "getsellerinfo/" + $scope.SellerId)
                .success(function(data, status) {
                  $scope.seller = data;
                });
            });
        ...
        if (id1[0] == "country" && id2[0] == "category") {
          ...
          $http
            .post(baseurl + "filterbyCouCat", $scope.filter)
            .success(function(data, status) {
              $scope.productslist = data;
        ...
        if (id1[0] == "category" && id2[0] == "subcategory") {
          ...
          $http
            .post(
              baseurl + "filterbyCatSub" + "/" + id1[1] + "/" + id2[1],
              $scope.filter
            )
            .success(function(data, status) {
              $scope.productslist = data;
        ...
        if (id1[0] == "seller" && id2[0] == "category") {
          ...
          $scope.filter.CategoryId = id2[1];
          $http
            .post(baseurl + "filterbySelCat", $scope.filter)
            .success(function(data, status) {
              $scope.productslist = data;
        ...
        if (
          ...
          $http
            .post(baseurl + "filterbyall", $scope.filter)
            .success(function(data, status) {
              $scope.productslist = data;
              window.localStorage.setItem("filter_country", id1[1]);
              window.localStorage.setItem("filter_category", id2[1]);
        ...
        if (
          ...
          $scope.filter.SubCatId = id3[1];
          $http
            .post(baseurl + "filterallbyseller", $scope.filter)
            .success(function(data, status) {
              $scope.productslist = data;
              window.localStorage.setItem("filter_seller", id1[1]);
              window.localStorage.setItem("filter_category", id2[1]);
  ...
  $scope.buyerproductrequests = function() {
    ...
    $http
      .get(baseurl + "buyerproductrequests/" + $scope.userid)
      .success(function(res) {
        if (res.status == "false") {
        } else {
          // console.log(res);
  ...
  $scope.userproducts = function() {
    ...
    $http
      .get(baseurl + "userproducts/" + $scope.userid)
      .success(function(data, status) {
        console.log(data);
  ...
  $scope.disableProduct = function(ProductId) {
    ...
    $http
      .get(baseurl + "disableProduct/" + $scope.ProductId)
      .success(function(data, status) {
        if (filename === "seller-products.html") $scope.userproducts();
  ...
  $scope.enableProduct = function(ProductId) {
    ...
    $scope.ProductId = ProductId;
    $http
      .get(baseurl + "enableProduct/" + $scope.ProductId)
      .success(function(data, status) {
        if (filename === "seller-products.html") $scope.userproducts();
        else location.reload();
      });
  ...
  $scope.buyerorders = function() {
    ...
    $http
      .get(baseurl + "buyerorders/" + $scope.BuyerId)
      .success(function(data, status) {
        //console.log(data);
  ...
  $scope.sellerorders = function() {
    ...
    $http
      .get(baseurl + "sellerorders/" + $scope.SellerId)
      .success(function(data, status) {
        //console.log(data);
  ...
  $scope.addtowishlist = function() {
    ...
    if (window.localStorage.getItem("User_Id") <= 0) {
      ...
      $http
        .post(baseurl + "addtowishlist/", $scope.wish)
        .success(function(data, status) {
          //console.log(data);
          $scope.added = 1;
  ...
  $scope.removefromwishlist = function() {
    ...
    $http
      .post(baseurl + "removefromwishlist/", $scope.wish)
      .success(function(data, status) {
        //console.log(data);
        $scope.added = 0;
        var wishlist = JSON.parse(localStorage.getItem("wishlist"));
  ...
  $scope.shortlistedproducts = function() {
    ...
    $http
      .get(baseurl + "shortlistedproducts/" + $scope.BuyerId)
      .success(function(data, status) {
        //console.log(data);
  ...
  $scope.getrecentproducts = function(req, res) {
    ...
    if (window.localStorage.getItem("Recent_Products") == null) {
      ...
      $http
        .post(baseurl + "getrecentprod", $scope.reproducts)
        .success(function(data, status) {
  ...
  $scope.getbuyerinfo = function(req, res) {
    ...
    $http
      .get(baseurl + "getsellerinfo/" + User_Id)
      .success(function(data, status) {
        $scope.data = data;
  ...
  $scope.gettransactions = function(req, res) {
    ...
    $http
      .get(baseurl + "gettransactions/" + User_Id)
      .success(function(data, status) {
  ...
  $scope.withdrawamonut = function() {
    ...
    if ($scope.data.amount > $scope.balance) {
      ...
      $scope.data.balance =
        parseFloat($scope.balance) - parseFloat($scope.data.amount);
      $scope.data.withdraw =
        parseFloat($scope.withdraw) + parseFloat($scope.data.amount);
      $.getJSON("//api.ipify.org?format=jsonp&callback=?", function(data) {
        ...
        console.log($scope.data);
        $http
          .post(baseurl + "withdraw/", $scope.data)
          .success(function(res) {
            if (res.status == true) {
  ...
  $scope.enquiryinit = function(req, res) {
    ...
    if (parts.length > 1) {
      ...
      if (productId[0] == "id") {
          ...
          .success(function(data, status) {
            ...
            if ($scope.enquiry.Type == "Product") {
              ...
              if (window.localStorage.getItem("User_Id") > 0) {
                ...
                $scope.enquiry.fullname = window.localStorage.getItem(
                  "User_Name"
                );
                $scope.enquiry.email = window.localStorage.getItem(
                  "User_Email"
                );
                $scope.enquiry.phonenumber = window.localStorage.getItem(
                  "User_Phone"
                );
              }
            }
            if ($scope.enquiry.Type == "Request") {
              ...
              $http
                .get(baseurl + "getbiddings/" + $scope.enquiry.productId)
                .success(function(data, status) {
        ...
        $http
          .get(baseurl + "getReqProductDetails/" + $scope.enquiry.productId)
          .success(function(data, status) {
            $scope.enquiry.productname = data.ProductName;
            $scope.enquiry.BuyerName =
              data.SupFirstName + " " + data.SupLastName;
        ...
        $http
          ...
          .success(function(data, status) {
            ...
            if (window.localStorage.getItem("User_Id") > 0) {
              ...
              var sellercountryId = parseInt(
                window.localStorage.getItem("User_Location")
              );
              $http
                .get(baseurl + "getcountry/" + sellercountryId)
                .success(function(data, status) {
                  // console.log(data);
            ...
            $http
              .get(baseurl + "getbiddings/" + productId[1])
              .success(function(data, status) {
                // console.log(data);
                $scope.biddinglist = data;
              });
  ...
  $scope.productinit = function(req, res) {
    ...
    if (parts.length > 1) {
      ...
      $http
        .get(baseurl + "getProductDetails/" + $scope.product.productId)
        .success(function(data, status) {
          $scope.product = data;
          if ($scope.product.ProductType == "Request") {
            ...
            $http
              .get(baseurl + "bidinfo/" + $scope.product.BidId)
              .success(function(data, status) {
                //console.log(data);
                ...
                $scope.amt =
                  ($scope.product.MinOrderQty *
                    $scope.product.Price *
                    $scope.per) /
                  100;
                $scope.amt1 =
                  ($scope.product.orderqty *
                    $scope.product.Price *
                    $scope.per) /
                  100;
              });
          ...
          $scope.product.buyercountryId = parseInt(
            window.localStorage.getItem("User_Location")
          );
          $http
            .get(baseurl + "getcountry/" + $scope.product.buyercountryId)
            .success(function(data, status) {
              // console.log(data);
              $scope.product.buyercountry = data.CountryTitle;
            });
          ...
          else $scope.product.orderqty = 10;
...
*/
          ...
          $scope.per = 100;
          $scope.amt =
            ($scope.product.MinOrderQty * $scope.product.Price * $scope.per) /
            100;
          /* $scope.terms1 = "50% Against Delivery";  */
          /* $scope.types1 = "Trade Exchange Escrow (TEE)"; */
          /*  $scope.per1 = 50; */
          ...
          if (window.localStorage.getItem("User_Id") > 0) {
            ...
            $scope.product.phonenumber = window.localStorage.getItem(
              "User_Phone"
            );
          }
      ...
      $http
        .get(baseurl + "getProductSpecification/" + $scope.product.productId)
        .success(function(data, status) {
    ...
    if (parts.length > 1) {
      ...
      $http
        ...
        .success(function(data, status) {
          ...
          $http
            .get(baseurl + "getHistory/" + $scope.order.OrderId)
            .success(function(data, status) {
              // console.log(data);
          ...
          $http
            ...
            .success(function(data, status) {
              ...
              $scope.order.sellername = window.localStorage.getItem(
                "User_Name"
              );
              $scope.order.selleremail = window.localStorage.getItem(
                "User_Email"
              );
            });
        });
  ...
  $scope.buyerorder = function(req, res) {
    ...
    if (parts.length > 1) {
      ...
      $http
        .post(baseurl + "GetbuyerOrderDetails", $scope.order)
        .success(function(data, status) {
          // console.log(data);
          ...
          $http
            ...
            .success(function(data, status) {
              ...
              $.each($scope.termslist, function(index, value) {
                ...
                if (
                  value.Type == "Telegraphic Transfer (TT)" ||
                  value.Type == "Letter Of Credit (LOC)"
                ) {
                  $scope.bankdetails = 1;
                }
              });
              ...
              if ($scope.bankdetails == 1) {
                $http
                  .get(baseurl + "getBankDetails/" + $scope.order.SuplierId)
                  .success(function(data, status) {
                    console.log(data);
                    $scope.bank = data;
                  });
          ...
          var buyercountryId = parseInt(
            window.localStorage.getItem("User_Location")
          );
          $http
            .get(baseurl + "getcountry/" + buyercountryId)
            .success(function(data, status) {
              // console.log(data);
              $scope.order.buyercountry = data.CountryTitle;
              $scope.order.buyername = window.localStorage.getItem("User_Name");
              $scope.order.buyeremail = window.localStorage.getItem(
                "User_Email"
              );
            });
        });
    ...
    $http
      ...
      .success(function(data, status) {
        ...
        if ($scope.transactionlist.length > 0) {
          ...
          $http
            .post(baseurl + "changeCurrency/", $scope.currency)
                        ...
                        .success(function(data1, status) {
                          ...
                          $http
                            ...
                            .success(function(data2, status) {
                              ...
                              $scope.order.buyername = window.localStorage.getItem(
                                "User_Name"
                              );
                              $scope.order.buyeremail = window.localStorage.getItem(
                                "User_Email"
                              ...
                              $scope.order.balance =
                                parseFloat($scope.balance) -
                                parseFloat(res.data.converted);
                              $.getJSON(
                                "//api.ipify.org?format=jsonp&callback=?",
                                function(data4) {
                                  // response = JSON.stringify(data, null, 2);
                                  var response = data4;
                                  ...
                                  console.log($scope.order);
                                  $http
                                    .post(baseurl + "payNow/", $scope.order)
                                    .success(function(res) {
                                      if (res.status == true) {
                                        if (res.count == 0)
  ...
  $scope.sellerterms = function() {
    ...
    $http
      ...
      .success(function(data, status) {
        ...
        // console.log($scope.data);
        $http
          .post(baseurl + "sellerTerms/", $scope.data)
          .success(function(data, status) {
            console.log(data);
  ...
  $scope.buyerterms = function() {
    ...
    $http
      ...
      .success(function(data, status) {
        ...
        // console.log($scope.data);
        $http
          .post(baseurl + "buyerTerms/", $scope.data)
          .success(function(data, status) {
            console.log(data);
  ...
  $scope.sellerapprove = function() {
    ...
    $http
      ...
      .success(function(data, status) {
        ...
        //console.log($scope.data);
        $http
          .post(baseurl + "sellerapprove/", $scope.data)
          .success(function(data, status) {
            window.location.href = "seller-order-details.html?id=" + orderId;
          });
      });
  ...
  $scope.buyerapprove = function() {
    ...
    $http
      ...
      .success(function(data, status) {
        ...
        //console.log($scope.data);
        $http
          .post(baseurl + "buyerapprove/", $scope.data)
          .success(function(data, status) {
            window.location.href = "buyer-order-details.html?id=" + orderId;
          });
      });
  ...
  $scope.buyerdelete = function() {
    ...
    $http
      ...
      .success(function(data, status) {
        ...
        //console.log($scope.data);
        $http
          .post(baseurl + "buyerdelete/", $scope.data)
          .success(function(data, status) {
            window.location.href = "buyer-order-details.html?id=" + orderId;
          });
      });
  ...
  $scope.getcurrency = function() {
    ...
    $http
      .get(baseurl + "getcurrency/" + $scope.product.CountryId)
      .success(function(data, status) {
        // console.log(data);
  ...
  $scope.calculate = function(product, index) {
    ...
    $scope.product.amount[index] = parseFloat(
      ($scope.product.Price *
        $scope.product.orderqty *
  ...
  $scope.cal = function(product, per) {
    ...
    $scope.product = product;
    $scope.per = per;
    $scope.amt = parseFloat(
      ($scope.product.Price * $scope.product.MinOrderQty * $scope.per) / 100
    ).toFixed(2);
    if ($scope.amt == 0) {
      $scope.amt = "";
    }
    if (typeof $scope.product.percentage !== "undefined") {
      $.each($scope.product.percentage, function(key, value) {
        $scope.product.amount[key] = parseFloat(
          ($scope.product.Price *
            $scope.product.MinOrderQty *
            $scope.product.percentage[key]) /
            100
        ).toFixed(2);
      });
    }
...
*/
  ...
  $scope.changeType2 = function(index) {
    if (
      ...
      typeof $scope.product.type !== "undefined"
    ) {
      $.each($scope.product.type, function(key, value) {
  ...
  $scope.calterm = function(order, t) {
    $scope.t = t;
    $scope.t.Amount = parseFloat(
      (order.TotalAmount * t.Percentage) / 100
    ).toFixed(2);
  };
  ...
  $scope.getvalues = function(product) {
    ...
    $scope.percentage = 50;
    $scope.amount = parseFloat(
      (product.Price * product.orderqty * $scope.percentage) / 100
    ).toFixed(2);
  };
  ...
  $scope.submitenquiry = function(enquiryform) {
    ...
    $http
      .post(baseurl + "submitenquiry", $scope.enquiry)
      .success(function(data, status) {
        if (data.status == true) {
  ...
  $scope.postbid = function(enquiryform) {
    ...
    $http
      .post(baseurl + "postbid", $scope.enquiry)
      .success(function(data, status) {
        if (data.status == true) {
          $http
            .get(baseurl + "getbiddings/" + $scope.enquiry.ProductId)
  ...
  $scope.conversation = function() {
    ...
    $scope.conversation.OtherUserId = window.localStorage.getItem(
      "Other_User_Id"
    );
    $scope.conversation.ProductId = window.localStorage.getItem(
      "Conversation_Product_Id"
    );
    // console.log($scope.conversation);

    $http
      .post(baseurl + "conversation/", $scope.conversation)
      .success(function(data, status) {
  ...
  $scope.conversationlist = function() {
    ...
    $http
      .get(baseurl + "conversationlist/" + $scope.userid)
      .success(function(data, status) {
        // console.log(data);
        ...
        if (parts.length > 1) {
          ...
          $http
            .get(baseurl + "getProductName/" + $scope.ProductId)
            .success(function(data, status) {
              // console.log(data);
          ...
          window.localStorage.setItem(
            "Other_User_Id",
            $scope.conversationlist[0].SupId
          );
          window.localStorage.setItem(
            "Conversation_Product_Id",
            $scope.conversationlist[0].ProductId
          );
      ...
      $http
        ...
        .success(function(data, status) {
          ...
          if (parts.length > 1) {
            ...
            $scope.conv.OtherUserId = window.localStorage.getItem(
              "Other_User_Id"
            );
            $scope.conv.ProductId = window.localStorage.getItem(
              "Conversation_Product_Id"
            );
            window.localStorage.setItem(
              "Conversation_Product_Id",
            ...
            $http
              .post(baseurl + "conversation/", $scope.conv)
              .success(function(data, status) {
                $scope.conversation = data;
                // console.log($scope.conversation);
              });
  ...
  $scope.sendmessage = function(message) {
    ...
    $scope.message.ProductId = window.localStorage.getItem(
      "Conversation_Product_Id"
    );
    ...
    $http
      .post(baseurl + "sendmessage/", $scope.message)
      .success(function(data, status) {
  ...
  $scope.confirmorder = function() {
    $http
      .post(baseurl + "placeorder/", $scope.product)
      .success(function(res) {
        // $("#orderform").hide();
        // $("#payform").hide();
        // $("#thankyou").show("slow");
  ...
  $scope.stripeCallback = function(code, result) {
    ...
    if (result.error) {
      ...
      //console.log($scope.data);
      $http
        .post(baseurl + "addorder/", $scope.product)
        .success(function(res) {
          $scope.response = res;
          //  console.log(res);
          if (res.status == "false") {
  ...
  $scope.booknow = function(req, res) {
    ...
    $http
      .post(baseurl + "consult/", $scope.data)
      .success(function(res) {
        if (res.status == "false") {
        }
      })
